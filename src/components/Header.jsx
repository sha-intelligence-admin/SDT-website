          ...
          <>
            ...
            >
              ...
              <div className="flex flex-col space-y-6 font-medium text-gray-700">
                <Link to="/funding" className="hover:text-secondary transition" onClick={closeDrawer}>
                  Funding & Programs
                </Link>
                <Link to="/about" className="hover:text-secondary transition" onClick={closeDrawer}>
                  About SDT
                </Link>
                <Link to="/terms" className="hover:text-secondary transition" onClick={closeDrawer}>
                  Terms
                </Link>
                <Link to="/privacy" className="hover:text-secondary transition" onClick={closeDrawer}>
                  Privacy
                </Link>
              </div>
            </motion.aside>
