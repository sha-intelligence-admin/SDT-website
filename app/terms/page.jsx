    ...
    <div>
      <section className="w-full min-h-[600px] flex flex-col items-center justify-center bg-white overflow-hidden">
        ...
        >
          ...
          <h1 className="mt-8 google-display-medium text-google-primary max-w-4xl mx-auto">
      ...
      <section className="relative w-full mt-16 flex flex-col items-center justify-between bg-white overflow-hidden px-6 py-16">
        <div className="max-w-4xl w-full space-y-12">
          <motion.div
            ...
            className="w-full"
          >
            <h2 className="google-headline-medium text-google-primary mb-4">Data Collection & Usage</h2>
            <p className="google-body-large text-google-secondary">
          ...
          <motion.div
            ...
            className="w-full"
          >
            <h2 className="google-headline-medium text-google-primary mb-4">Data Protection</h2>
            <p className="google-body-large text-google-secondary">
          ...
          <motion.div
            ...
            className="w-full"
          >
            <h2 className="google-headline-medium text-google-primary mb-4">Compliance Standards</h2>
            <p className="google-body-large text-google-secondary">
          ...
          <motion.div
            ...
            className="w-full"
          >
            <h2 className="google-headline-medium text-google-primary mb-4">Your Control</h2>
            <p className="google-body-large text-google-secondary">
          ...
          <motion.div
            ...
            className="w-full"
          >
            <h2 className="google-headline-medium text-google-primary mb-4">Our Commitment</h2>
            <p className="google-body-large text-google-secondary">
